...
from telegram import BotCommandScopeAllGroupChats, Update, constants,Update, InputFile
...
class ChatGPTTelegramBot:
    ...
    def __init__(self, config: dict, openai: OpenAIHelper):
        ...
        self.commands = [
            ...
            BotCommand(command='slides',description=localized_text('slides_description',bot_language))
        ]
    ...
    async def help(self, update: Update, _: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        help_text = (
                ...
                '\n\n'+
                '\n\n Kindly contact https://t.me/M_y_e_r_s_2_4_7 for more information'
        )
    ...
    async def slides(self, update: Update, context: CallbackContext) -> None:
        '''
        provides pdfs or pptx for users
        '''
        creds = None
    ...
    def run(self):
        ...
        application.add_handler(CommandHandler('slides',self.slides))
